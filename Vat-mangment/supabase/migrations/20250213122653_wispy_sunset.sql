/*
  # Fresh Database Schema for VAT Calculator

  1. Overview
    Creates a simplified database schema for VAT tracking without authentication dependencies.
    All tables have public access for demonstration purposes.

  2. Tables
    - transactions: Stores all financial transactions with VAT details
    - documents: Stores reference documents and links
    - upload_history: Tracks file uploads
    - report_history: Tracks report generation
