/*
  ...
  1. Overview
    - Creates a fresh database schema without authentication dependencies
    - Includes basic tables for VAT tracking and reporting
    - Enables RLS with public access for demo purposes
